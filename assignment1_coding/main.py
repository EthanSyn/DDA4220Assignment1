...
def main():
    train_loss_history, train_acc_history, valid_loss_history, valid_acc_history = run('sgd')
    plot_curves(train_loss_history, train_acc_history, valid_loss_history, valid_acc_history, fname_prefix='sgd_')
    train_loss_history, train_acc_history, valid_loss_history, valid_acc_history = run('adamw')
    plot_curves(train_loss_history, train_acc_history, valid_loss_history, valid_acc_history, fname_prefix='adamw_')

def run(opt_type='sgd'):
    global args
    ...
    if opt_type == 'sgd':
        ...
        optimizer = AdamW(learning_rate=args.learning_rate, reg=args.reg, beta1=0.9, beta2=0.999, epsilon=1e-8)
    else:
